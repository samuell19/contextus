...
const envSchema = z.object({
  ...
  CONTEXT_WINDOW_TOKENS: z.coerce.number().int().positive().default(3200),
  CONTEXT_RESPONSE_RESERVE_TOKENS: z.coerce.number().int().positive().default(900),
  CONTEXT_SUMMARY_MAX_TOKENS: z.coerce.number().int().positive().default(320),
  CONTEXT_TOOL_MAX_TOKENS: z.coerce.number().int().positive().default(900),
  CONTEXT_AGENT_PROMPT_MAX_TOKENS: z.coerce.number().int().positive().default(500),
  CONTEXT_RECENT_MESSAGES_MAX: z.coerce.number().int().positive().default(8),
  CONTEXT_CHARS_PER_TOKEN: z.coerce.number().int().positive().default(4),
