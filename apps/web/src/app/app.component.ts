    ...
    <ng-template #loading>
      <main class="min-h-screen flex items-center justify-center p-6">
        <div class="glass-panel p-8 max-w-md w-full animate-rise text-center space-y-4 relative overflow-hidden">
          <p class="text-xs font-extrabold tracking-[0.14em] text-ui-300 uppercase mb-2">Contextus</p>
          ...
          <div class="flex justify-center pt-5 pb-1">
            <div class="flex gap-2">
              <div class="w-2.5 h-2.5 rounded-full bg-white animate-soft-pulse"></div>
              <div class="w-2.5 h-2.5 rounded-full bg-ui-300 animate-soft-pulse" style="animation-delay: 0.18s;"></div>
              <div class="w-2.5 h-2.5 rounded-full bg-ui-500 animate-soft-pulse" style="animation-delay: 0.36s;"></div>
            </div>
          </div>
        </div>
      </main>
